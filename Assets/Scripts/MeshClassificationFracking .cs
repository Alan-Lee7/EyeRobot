...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    // #if UNITY_IOS && !UNITY_EDITOR
        ...
        void OnMeshesChanged(ARMeshesChangedEventArgs args)
        {
            ...
            // };
            //
            // var navMeshBuildSources = new ArrayList();
            // navMeshBuildSources.Add(navMeshBuildSource);

            // var navMeshData = NavMeshBuilder.BuildNavMeshData(new NavMeshBuildSettings(), navMeshBuildSources, new Bounds(new Vector3(0, 0, 0), new Vector3(1, 2, 1)););
